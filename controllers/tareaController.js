...
const agregarTarea = async (req, res) => {
    ...
    // Comprueba que el usuario que agrega la tarea sea el creador del proyecto
...
const obtenerTarea = async (req, res) => {
    ...
    if (!tarea) {
        const error = new Error('La tarea solicitada no encontrada');
        return res.status(404).json({ msg: error.message });
    }
...
const cambiarEstado = async (req, res) => {
    ...
    // Permite la modificación solo al creador o colaborador
